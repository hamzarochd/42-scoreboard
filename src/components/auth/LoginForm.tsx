      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            {API_MODE === 'REAL' ? 'Choose your preferred login method' : 'Enter your demo credentials or use OAuth simulation'}
          </p>
        </div>

        {/* OAuth Login Button - Show only when using real API */}
        {API_MODE === 'REAL' && (
          <div className="space-y-4">
            ...
            >
              <span className="mr-2">Sign in with 42 School</span>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gray-50 dark:bg-gray-900 text-gray-500 dark:text-gray-400">Or continue with credentials</span>
              </div>
            </div>
          </div>
        )}
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Enter your 42 login"
                />
              </div>
            </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <p className="text-sm text-blue-700 dark:text-blue-400">
              <strong>Demo credentials:</strong> hmrochd / password
            </p>
          </div>
